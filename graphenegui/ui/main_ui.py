...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/img/svg/dark_light_mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/img/svg/reduce.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/img/svg/prob.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/img/svg/remove_one.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
