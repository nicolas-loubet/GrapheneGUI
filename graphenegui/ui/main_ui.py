...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/img/svg/cnt.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnCNT.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/img/svg/reduce_H.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnReduceExternal.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icons/img/svg/dark_light_mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/img/svg/oh.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnAddOH.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/img/svg/o.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnAddO.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/img/svg/remove_one.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnRemoveOx.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/img/svg/reduce.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnReduceAll.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/img/svg/prob.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnChangeProb.setIcon(icon14)
