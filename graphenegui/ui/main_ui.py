...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/img/svg/icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/img/svg/create.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/img/svg/duplicate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnDuplicate.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/img/svg/delete.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/img/svg/import.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnImport.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/img/svg/export.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnExport.setIcon(icon5)
        self.btnExport.setIconSize(QSize(25, 25))
        self.topToolBar.addWidget(self.btnExport)
        self.btnSaveWork = QPushButton(self.topToolBar)
        self.btnSaveWork.setObjectName(u"btnSaveWork")
        self.btnSaveWork.setMinimumSize(QSize(100, 40))
        icon6 = QIcon()
        icon6.addFile(u":/icons/img/svg/save_work.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnSaveWork.setIcon(icon6)
        self.btnSaveWork.setIconSize(QSize(25, 25))
        self.topToolBar.addWidget(self.btnSaveWork)
        self.btnOpenWork = QPushButton(self.topToolBar)
        self.btnOpenWork.setObjectName(u"btnOpenWork")
        self.btnOpenWork.setMinimumSize(QSize(100, 40))
        icon7 = QIcon()
        icon7.addFile(u":/icons/img/svg/open_work.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnOpenWork.setIcon(icon7)
        self.btnOpenWork.setIconSize(QSize(25, 25))
        self.topToolBar.addWidget(self.btnOpenWork)
        self.btnCNT = QPushButton(self.topToolBar)
        self.btnCNT.setObjectName(u"btnCNT")
        self.btnCNT.setMinimumSize(QSize(100, 40))
        icon8 = QIcon()
        icon8.addFile(u":/icons/img/svg/cnt.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnCNT.setIcon(icon8)
        self.btnCNT.setIconSize(QSize(25, 25))
        self.topToolBar.addWidget(self.btnCNT)
        self.btnReduceExternal = QPushButton(self.topToolBar)
        self.btnReduceExternal.setObjectName(u"btnReduceExternal")
        self.btnReduceExternal.setMinimumSize(QSize(100, 40))
        icon9 = QIcon()
        icon9.addFile(u":/icons/img/svg/reduce_H.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnReduceExternal.setIcon(icon9)
        self.btnReduceExternal.setIconSize(QSize(25, 25))
        self.topToolBar.addWidget(self.btnReduceExternal)
        self.btnTheme = QPushButton(self.topToolBar)
        self.btnTheme.setObjectName(u"btnTheme")
        self.btnTheme.setMinimumSize(QSize(100, 40))
        icon10 = QIcon()
        icon10.addFile(u":/icons/img/svg/dark_light_mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnTheme.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/img/svg/oh.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnAddOH.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/img/svg/o.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnAddO.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/img/svg/remove_one.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnRemoveOx.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/img/svg/reduce.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnReduceAll.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/img/svg/prob.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnChangeProb.setIcon(icon15)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnSaveWork.setText(QCoreApplication.translate("MainWindow", u"Save Work", None))
        self.btnOpenWork.setText(QCoreApplication.translate("MainWindow", u"Open Work", None))
        self.btnCNT.setText(QCoreApplication.translate("MainWindow", u"CNT", None))
        self.btnReduceExternal.setText(QCoreApplication.translate("MainWindow", u"Reduce Borders", None))
