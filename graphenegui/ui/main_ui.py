...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"graphenegui/ui/img/svg/create.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"graphenegui/ui/img/svg/duplicate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"graphenegui/ui/img/svg/delete.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"graphenegui/ui/img/svg/import.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"graphenegui/ui/img/svg/export.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"graphenegui/ui/img/svg/dark_light_mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u"graphenegui/ui/img/svg/reduce.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnReduceAll.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"graphenegui/ui/img/svg/prob.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.btnChangeProb.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u"graphenegui/ui/img/svg/remove_one.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
